...
public class Adapterartikel extends RecyclerView.Adapter<Adapterartikel.Holder>{
    ...
    public Adapterartikel(ArrayList<Integer> id,ArrayList<String> url,ArrayList<String> header, ArrayList<String> detail, ArtikelActivity ct){
        this.id=id;
        this.url=url;
        this.header=header;
        this.detail=detail;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.listdata_artikel,parent,false);
        return new Holder(v);
    }
