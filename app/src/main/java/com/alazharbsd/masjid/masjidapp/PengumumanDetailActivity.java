...
public class PengumumanDetailActivity extends AppCompatActivity {
    ...
    public void loadata(){
        RequestQueue rq= Volley.newRequestQueue(PengumumanDetailActivity.this);
        StringRequest sr=new StringRequest(Request.Method.GET, Config.url+"/masjidapp/rest/pengumuman.php?id="+id,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < ja.length() ; i++) {
                                ...
                                Glide.with(PengumumanDetailActivity.this).
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(PengumumanDetailActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        rq.add(sr);
    }
